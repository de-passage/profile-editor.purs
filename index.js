...
(function($PS) {
  ...
  var LocStr = function (x) {
      return x;
  };
  var semigroupText = new Data_Semigroup.Semigroup(function (v) {
      return function (v1) {
          return v + v1;
      };
  });
  var monoidText = new Data_Monoid.Monoid(function () {
      return semigroupText;
  }, Data_Monoid.mempty(Data_Monoid.monoidString));
  var editor = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.container) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.dropdown) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnSecondary ]) ])([ Halogen_HTML_Core.text(state.currentKey) ]) ]) ]) ]) ]);
      };
      var initialState = function (v) {
          return {
              dictionary: Foreign_Object.empty,
              currentKey: Data_Monoid.mempty(Data_Monoid.monoidString),
              currentEn: Data_Monoid.mempty(monoidText),
              currentJp: Data_Monoid.mempty(Data_Maybe.monoidMaybe(semigroupText)),
              currentFr: Data_Monoid.mempty(Data_Maybe.monoidMaybe(semigroupText))
          };
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("done")))(function () {
          return Halogen_VDom_Driver.runUI(editor(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
      });
  }));
  ...
  exports["semigroupText"] = semigroupText;
  exports["monoidText"] = monoidText;
})(PS);
PS["Main"].main();